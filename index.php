...
<head>
    ...
    <!-- Page Title -->
    <title>Ann Treesa Biju | Portfolio </title>

    <!-- Meta Tags -->
    <meta name="description" content="Ann Treesa Biju | Portfolio">
    <meta name="keywords" content="Ann Treesa Biju | Portfolio">
    <meta name="author" content="Ann Treesa Biju">
    ...
    <meta property="og:title" content="Ann Treesa Biju | Portfolio">
    <meta property="og:description" content="Ann Treesa Biju | Portfolio">
  ...
  <body>
    ...
    <header id="header" class="header d-flex justify-content-between">
      ...
      <div class="header__controls d-flex justify-content-end">
        ...
        <a id="notify-trigger" class="header__trigger btn" href="mailto:anntreesa028@gmail.com">
        ...
        <div class="avatar__block">
          <div class="avatar__logo d-flex align-items-center">
            <div class="logo__image">
              ...
              height: 50px;" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                 viewBox="0 0 85 85" 
            ...
            <div class="logo__caption">
              <p>Ann Treesa Biju<br></p>
            </div>
          </div>
          <div class="avatar__image">
            <img src="img/avatars/1024x1024_a04.webp" alt="img">
          </div>
        </div>
        <!-- data caption #1 -->
        <div class="avatar__block">
          ...
          <div class="avatar__socials">
            <ul class="socials-square d-flex justify-content-between">
              <li class="socials-square__item">
                <a class="socials-square__link btn" href="https://dribbble.com/" target="_blank"><i class="ph-bold ph-linkedin-logo"></i></a>
              </li>
              <li class="socials-square__item">
                <a class="socials-square__link btn" href="https://www.behance.net/" target="_blank"><i class="ph-bold ph-github-logo"></i></a>
              </li>
              <li class="socials-square__item">
      ...
      <div class="content__wrapper">
        ...
        <section id="home" class="main intro">
          ...
          <div id="headline" class="headline d-flex align-items-start flex-column" data-speed="1">
            ...
            <h1 class="headline__title animate-headline">I'm Ann Treesa Biju<br>Frontend Developer and UI/UX Enthusiast.</h1>
        ...
        <section id="portfolio" class="inner inner-first portfolio d-none">
            ...
            <div class="container-fluid p-0">
              <div class="row g-0 justify-content-between">
                ...
                <div class="col-12 col-xl-8 grid-item about-descr">
                  ...
                  <p style="text-align: justify;" class="about-descr__text animate-in-up">
                    As a passionate Frontend Developer, I specialize in creating user-friendly, responsive, and dynamic web interfaces. I have hands-on experience with modern technologies like HTML, CSS, JavaScript, and frameworks such as 
                    <a href="#0" class="text-link">React and Angular.</a> 
                   
                  </p>
                  <p style="text-align: justify;" class="about-descr__text animate-in-up">
                   I focus on delivering pixel-perfect designs, optimized performance, and seamless user experiences. My work reflects a strong commitment to  
                    <a href="#0" class="text-link">writing clean, maintainable code</a> 
                    and collaborating effectively with cross-functional teams to bring ideas to life.
                  </p>
                ...
                <div class="col-12 col-xl-4 grid-item about-info">
                  ...
                  <div class="about-info__item animate-in-up">
                    <h6>
                      ...
                      <a class="text-link-bold" href="tel:+91 7012924149">+91 7012924149</a>
                    </h6>
                  </div>
                  <div class="about-info__item animate-in-up">
                    <h6>
                      <small class="top">Email</small>
                      <a class="text-link-bold" href="mailto:anntreesa028@gmail.com">anntreesa028@gmail.com</a>
                    </h6>
                  </div>
                  <div class="about-info__item animate-in-up">
                    <h6>
                      <small class="top">Location</small>
                      <a class="text-link-bold" href="#" target="_blank">Ernakulam , Kerala</a>
                    </h6>
                  </div>
                </div>
            ...
            <div class="container-fluid p-0">
              <div class="row g-0 align-items-stretch cards">
                ...
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    <div class="cards__descr">
                      <h4 class="cards__title animate-in-up">Custom Frontend <br>Development</h4>
                      <div class="cards__tags d-flex flex-wrap animate-in-up">
                        <span class="rounded-tag tag-outline">Responsive Design</span>
                        <span class="rounded-tag tag-outline">Interactive UI</span>
                      </div>
                      <p class="small cards__text animate-in-up">Building responsive, dynamic, and visually appealing web applications using modern frameworks like React,  and Angular.</p>
                    </div>
                ...
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    <div class="cards__descr">
                      <h4 class="cards__title animate-in-up">UI/UX Development</h4>
                      <div class="cards__tags d-flex flex-wrap animate-in-up">
                        <span class="rounded-tag tag-outline">UI/UX Design</span>
                        <span class="rounded-tag tag-outline">Design to Code</span>
                      </div>
                      <p class="small cards__text animate-in-up">Crafting intuitive, user-focused interfaces that ensure smooth navigation and optimal user engagement across devices.
                      </p>
                    </div>
                    <div class="cards__image d-flex animate-in-up">
                ...
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    <div class="cards__descr">
                      <h4 class="cards__title animate-in-up">Responsive Web Design  </h4>
                      <div class="cards__tags d-flex flex-wrap animate-in-up">
                        <span class="rounded-tag tag-outline">Fluid Layouts</span>
                        <span class="rounded-tag tag-outline">Cross-Device Compatibility</span>
                      </div>
                      <p class="small cards__text animate-in-up">Ensuring websites are mobile-first and adaptive, delivering seamless performance across all screen sizes and browsers.
                      </p>
                    </div>
                ...
                <div class="col-12 col-md-6 cards__item grid-item animate-card-2">
                  <div class="cards__card d-flex flex-column">
                    <div class="cards__descr">
                      <h4 class="cards__title animate-in-up">Performance & SEO Optimization</h4>
                      <div class="cards__tags d-flex flex-wrap animate-in-up">
                        <span class="rounded-tag tag-outline">Speed Optimization</span>
                        <span class="rounded-tag tag-outline">SEO Best Practices</span>
                      </div>
                      <p class="small cards__text animate-in-up">Boosting site speed, accessibility, and search engine visibility by implementing best practices like code minification and responsive design.
                      </p>
                    </div>
                    <div class="cards__image d-flex animate-in-up">
        ...
        <section id="resume" class="inner resume">
          ...
          <div class="content__block block-large">
            ...
            <p class="h2__text animate-in-up">
              With a solid academic background in computer science and hands-on experience in 

           
              <a href="#0" class="text-link">frontend development</a> 
              , I have honed my skills in building responsive, user-friendly web applications. My education, combined with practical work, has equipped me with the technical expertise to deliver impactful digital solutions.
            </p>
          </div>
          <!-- Content Block - H2 Section Title End -->
            ...
            <div class="container-fluid p-0 resume-lines">
              ...
              <div class="row g-0 resume-lines__item animate-in-up">
                <div class="col-12 col-md-2">
                  <span class="resume-lines__date animate-in-up">2020 - 2023</span>
                </div>
                <div class="col-12 col-md-5">
                  <h5 class="resume-lines__title animate-in-up">Bachelor of Computer Application</h5>
                  
                </div>
                <div class="col-12 col-md-5">
                  <p class="small resume-lines__descr animate-in-up">Mar Sleeva College of Art and Science  
                    Murickassery , Idukki , Kerala</p>
                </div>
              </div>
              <!-- education single item -->
              <div class="row g-0 resume-lines__item animate-in-up">
                ...
                <div class="col-12 col-md-5">
                  <h5 class="resume-lines__title animate-in-up">12<sup style="font-size: 15px;">th </sup></h5>
                  
                  
                </div>
                <div class="col-12 col-md-5">
                  <p class="small resume-lines__descr animate-in-up">St. Mary’s Higher Secondary School 
                    Murickassery , Idukki , Kerala
         </p>
                </div>
              </div>
              <!-- education single item -->
              <div class="row g-0 resume-lines__item animate-in-up">
                <div class="col-12 col-md-2">
                  <span class="resume-lines__date animate-in-up">2018</span>
                </div>
                <div class="col-12 col-md-5">
                  <h5 class="resume-lines__title animate-in-up">10<sup  style="font-size: 15px;">th</sup></h5>
          ...
          <div class="content__block block-large">
            ...
            <div class="container-fluid p-0 resume-lines">
              ...
              <div class="row g-0 resume-lines__item animate-in-up">
                ...
                <div class="col-12 col-md-5">
                  <h5 class="resume-lines__title animate-in-up">Software Developer</h5>
                  <p class="resume-lines__source animate-in-up">in  
                    <a href="#0" class="text-link-bold" target="_blank">Coreminds Innovations</a>
                    Infopark
                  </p>
                </div>
                <div class="col-12 col-md-5">
                  <p style="text-align: justify;" class="small resume-lines__descr animate-in-up">Developed <strong><b class="text-link-bold">50+</b></strong> responsive web interfaces with custom PHP CMS for industries like hospitality, healthcare, and corporate solutions, enhancing online visibility for clients.</p>
                </div>
              </div>
              <!-- experience single item -->
              <div class="row g-0 resume-lines__item animate-in-up">
                ...
                <div class="col-12 col-md-5">
                  <h5 class="resume-lines__title animate-in-up">MEA(R)N Full Stack Developer</h5>
                  <p class="resume-lines__source animate-in-up">in 
                    <a href="#0" class="text-link-bold" target="_blank">Luminar Technolab</a>
                    Kochi
                  </p>
                </div>
                <div class="col-12 col-md-5">
                  <p  style="text-align: justify;"  class="small resume-lines__descr animate-in-up">I developed and deployed web applications using the MEA(R)N stack, focusing on building frontend interfaces and backend services for seamless functionality.</p>
                </div>
              </div>
            ...
            <div class="tools-cards d-flex justify-content-start flex-wrap">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <img class="tools-cards__icon animate-in-up" src="img/icons/rect.png" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <img class="tools-cards__icon animate-in-up" src="img/icons/js.webp" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <img class="tools-cards__icon animate-in-up" src="img/icons/bootstrap.webp" alt="Tools Icon">
                  <h6 class="tools-cards__caption animate-in-up">Bootstrap5</h6>
                </div>
              </div>
              <!-- tools simgle item -->
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <img class="tools-cards__icon animate-in-up" src="img/icons/php.png" alt="Tools Icon">
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <img class="tools-cards__icon animate-in-up" src="img/icons/vs.png" alt="Tools Icon">
                  <h6 class="tools-cards__caption animate-in-up">VS Code</h6>
                </div>
              </div>
              ...
              <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                <div class="tools-cards__card">
                  <img class="tools-cards__icon animate-in-up" src="img/icons/git.png" alt="Tools Icon">
        ...
        <section id="contact" class="inner contact">
          ...
          <div class="content__block grid-block text-center">
          ...
          <div class="content__block">
            <div class="teaser">
              <p  class="teaser__text animate-in-up">
                ...
                Looking for a dedicated Frontend Developer to build responsive, high-performance web interfaces or applications?    <a class="text-link-bold" href="mailto:anntreesa028@gamil.com"> Let’s connect</a>
              </p>
            </div>
          </div>
            ...
            <div class="container-fluid p-0 contact-lines animate-in-up">
              <div class="row g-0 contact-lines__item">
                ...
                <div class="col-12 col-md-4 contact-lines__data">
                  ...
                  <p class="contact-lines__text animate-in-up">
                    <a class="text-link-bold" href="mailto:eanntreesa028@gamil.com">anntreesa028@gamil.com</a>
                  </p>
                </div>
              </div>
            </div>
...
<!-- Mirrored from mixdesign.club/themeforest/braxton/index-image.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Dec 2024 12:04:51 GMT -->
</html>